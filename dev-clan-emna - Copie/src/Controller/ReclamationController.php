    ...
    public function statisreclamation(ReclamationRepository $ReclamationRepository)
{
      ...
      $bar->getOptions()->getVAxis()->setTitle('type_rec');
...
*/
    ...
    public function new(Request $request, ReclamationRepository $reclamationRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            try {
                ...
                $mail->Body    = "Reclamation jaoutée avec succés ,SUIIIIIIIIIIIIIIIIIIIIIIII ";
    ...
    public function delete(Request $request, Reclamation $reclamation, ReclamationRepository $reclamationRepository): Response
    {
        ...
        $message = $client->messages->create(
            ...
            [
                'from' => $twilioNumber,
                'body' => 'Votre réclamation a été supprimé avec Succés'. $reclamation->getDateRec()->format('m/d/Y') ,
            ]
        );
