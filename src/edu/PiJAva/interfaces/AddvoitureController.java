...
public class AddvoitureController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        autocompletionlTextField.setupAutoCompletion(marque_id);
        autocompletionlTextField.setupAutoCompletion(modele_id);
        autocompletionlTextField.setupAutoCompletion(matricule_id);
        autocompletionlTextField.setupAutoCompletion(kilometrage_id);
        voitureEtatList();
...
//
            voiture.addEntity(v);
            autocompletionlTextField.LearnWord(modele_id, modele_id.getText());
            autocompletionlTextField.LearnWord(marque_id, marque_id.getText());

            autocompletionlTextField.LearnWord(matricule_id, matricule_id.getText());

            autocompletionlTextField.LearnWord(modele_id, modele_id.getText());

            autocompletionlTextField.LearnWord(kilometrage_id, kilometrage_id.getText());
...
//    if (table_id.getSelectionModel().getSelectedItem() != null) {   
//        try {
//            int selectedCarId = table_id.getSelectionModel().getSelectedItem().getId();
//                            
//            FXMLLoader loader = new FXMLLoader(
//                getClass().getResource("addcontrat.fxml"));
//            Parent root = (Parent) loader.load();
//            AddcontratController contractViewController = loader.getController();
//            contractViewController.setSelectedCar(selectedCarId);
//
...
//}
    ...
    private void addcontrat(ActionEvent event) {
        if (table_id.getSelectionModel().getSelectedItem() != null) {
            try {
                int selectedVoiture = table_id.getSelectionModel().getSelectedItem().getId();
...
//    }}
    ...
    @FXML
    private void backv(ActionEvent event) {
