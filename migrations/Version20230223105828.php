 ...
 */
final class Version20230223105828 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE constat (id INT AUTO_INCREMENT NOT NULL, expert_id INT NOT NULL, id_client INT NOT NULL, id_vehicule INT NOT NULL, date DATE NOT NULL, lieu VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, INDEX IDX_F96EDD98C5568CE4 (expert_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
